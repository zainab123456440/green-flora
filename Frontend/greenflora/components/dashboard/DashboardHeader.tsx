 ...
 *
 * Greeting hero at the top of the dashboard. The greeting line is
 * generated by Green Flora AI — localized (English / Urdu) and aware
 * of the time of day — while the static name fallback renders
 * instantly. dir="auto" makes an Urdu greeting align right-to-left.
 *
 * A deep agricultural-green gradient band with a few very subtle
 * floating leaves behind the text — decorative elements sit behind
 * the content and never intercept pointer events, and the animations
 * are disabled entirely for users who prefer reduced motion (see
 * globals.css).
 */
...
interface DashboardHeaderProps {
  farmerName: string;
  /** AI-generated localized greeting; null while it loads. */
    ...
    <section className="relative mb-6 overflow-hidden rounded-2xl bg-gradient-to-br from-primary-800 via-primary-700 to-primary-600 p-6 shadow-elevated sm:p-8">
      ...
      <div className="relative">
        <div className="flex flex-wrap items-center gap-x-3 gap-y-1.5">
          <h1
            dir="auto"
            className="text-2xl font-semibold tracking-tight text-primary-50 sm:text-3xl"
          >
